...
!function (NioApp, $) {
    ...
    if ($(elm).exists() && typeof $.fn.vectorMap === 'function') {
      $(elm).each(function () {
        ...
        $self.vectorMap({
          ...
          scaleColors: ['#ccd7e2', '#0072bc'],
          selectedColor: '#0072bc',
          showTooltip: true,
  ...
  var TrafficChannelDoughnutData = {
    ...
    datasets: [{
      borderColor: "#fff",
      background: ["#0072bc", "#b8acff", "#ffa9ce", "#f9db7b"],
  ...
  var OrganicSearchData = {
    ...
    datasets: [{
      ...
      color: "#0072bc",
      background: NioApp.hexRGB('#0072bc', .25),
  ...
  var analyticOvData = {
    ...
    datasets: [{
      ...
      color: "#0072bc",
      dash: 0,
      background: NioApp.hexRGB('#0072bc', .15),
