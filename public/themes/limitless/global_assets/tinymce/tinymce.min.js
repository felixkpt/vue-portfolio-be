...
!function () {
    ...
    var e, t, n, r, o, i, a, u, s, c, l, f, d, m, p, g, h, v = function (e) {
        ...
        noop: function () {
        ...
        }, constant: v, identity: function (e) {
            return e
            ...
            e()
        }, never: v(!1), always: v(!0)
    }, y = V.never, b = V.always, C = function () {
        return x
    }, x = (r = {
        fold: function (e, t) {
            return e()
        }, is: y, isSome: y, isNone: b, getOr: n = function (e) {
            return e
        }, getOrThunk: t = function (e) {
            return e()
        }, getOrDie: function (e) {
            throw new Error(e || "error: getOrDie called on none.")
        }, or: n, orThunk: t, map: C, ap: C, each: function () {
        }, bind: C, flatten: C, exists: y, forall: b, filter: C, equals: e = function (e) {
            return e.isNone()
        }, equals_: e, toArray: function () {
            return []
        }, toString: V.constant("none()")
    }, Object.freeze && Object.freeze(r), r), w = function (n) {
        var e = function () {
            return n
        }, t = function () {
            return o
            ...
            fold: function (e, t) {
                ...
                return n === e
            }, isSome: b, isNone: y, getOr: e, getOrThunk: e, getOrDie: e, or: t, orThunk: t, map: function (e) {
                return w(e(n))
            }, ap: function (e) {
                ...
                e(n)
            }, bind: r, flatten: e, exists: r, forall: r, filter: function (e) {
                return e(n) ? o : x
            }, equals: function (e) {
                return e.is(n)
        ...
        return -1
    }, P = Array.prototype.push, L = function (e) {
        ...
        return !0
    }, M = Array.prototype.slice, F = E.isFunction(Array.from) ? Array.from : function (e) {
        return M.call(e)
    }, H = {
        map: T, each: R, eachr: B, partition: function (e, t) {
            for (var n = [], r = [], o = 0, i = e.length; o < i; o++) {
                var a = e[o];
                (t(a, o, e) ? n : r).push(a)
            }
            return {pass: n, fail: r}
        }, filter: _, groupBy: function (e, t) {
            ...
            return A.none()
        }, findIndex: D, flatten: L, bind: function (e, t) {
            var n = T(e, t);
            return L(n)
        }, forall: I, exists: function (e, t) {
            return D(e, t).isSome()
        }, contains: k, equal: function (e, n) {
    ...
    }, z = "undefined" != typeof window ? window : Function("return this;")(), U = function (e, t) {
    ...
    }, K = navigator, X = K.userAgent, Y = function (e) {
    ...
    var G, J, Q, Z, ee, te, ne, re, oe, ie, ae, ue, se, ce, le, fe, de, me, pe, ge = {
        ...
        }, setTimeout: ve, setInterval: ye, setEditorTimeout: function (e, t, n) {
            return ve(function () {
                e.removed || t()
            }, n)
        ...
        }, debounce: be, throttle: be, clearInterval: function (e) {
            return clearInterval(e)
        }, clearTimeout: function (e) {
            return clearTimeout(e)
        }
    }, xe = /^(?:mouse|contextmenu)|click/, we = {
        keyLocation: 1,
        layerX: 1,
        layerY: 1,
        returnValue: 1,
        ...
        if (s.target || (s.target = s.srcElement || document), ge.experimentalShadowDom && (s.target = (r = e, o = s.target, a = o, (i = r.path) && 0 < i.length && (a = i[0]), r.composedPath && (i = r.composedPath()) && 0 < i.length && (a = i[0]), a)), e && xe.test(e.type) && e.pageX === undefined && e.clientX !== undefined) {
            var c = s.target.ownerDocument || document, l = c.documentElement, f = c.body;
        ...
        y.bind = function (e, t, n, r) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                for (e[p] ? o = e[p] : (o = m++, e[p] = o, b[o] = {}), r = r || e, a = (t = t.split(" ")).length; a--;) c = d, s = l = !1, "DOMContentLoaded" === (u = t[a]) && (u = "ready"), y.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, Te({type: u})) : (h || (s = v[u]) && (c = function (e) {
                    var t, n;
                ...
                }), (i = b[o][u]) ? "ready" === u && y.domLoaded ? n({type: u}) : i.push({
                    func: n,
                    scope: r
                }) : (b[o][u] = i = [{
                    func: n,
            ...
            var r;
            if (!e || 3 === e.nodeType || 8 === e.nodeType) return y;
            for ((n = Te(null, n)).type = t, n.target = e; (r = e[p]) && C(n, r), (e = e.parentNode || e.ownerDocument || e.defaultView || e.parentWindow) && !n.isPropagationStopped();) ;
            return y
        }, y.clean = function (e) {
            var t, n, r = y.unbind;
            if (!e || 3 === e.nodeType || 8 === e.nodeType) return y;
            if (e[p] && r(e), e.getElementsByTagName || (e = e.document), e && e.getElementsByTagName) for (r(e), t = (n = e.getElementsByTagName("*")).length; t--;) (e = n[t])[p] && r(e);
            return y
        }, y.destroy = function () {
            b = {}
        }, y.cancel = function (e) {
    ...
    var Be = "sizzle" + -new Date, _e = window.document, De = 0, Oe = 0, Pe = mt(), Le = mt(), Ie = mt(),
        Me = function (e, t) {
            return e === t && (ue = !0), 0
        }, Fe = typeof undefined, ze = 1 << 31, Ue = {}.hasOwnProperty, qe = [], Ve = qe.pop, He = qe.push,
        je = qe.push, $e = qe.slice, We = qe.indexOf || function (e) {
        ...
        Qe = new RegExp("^" + Ke + "*," + Ke + "*"), Ze = new RegExp("^" + Ke + "*([>+~]|" + Ke + ")" + Ke + "*"),
        et = new RegExp("=" + Ke + "*([^\\]'\"]*?)" + Ke + "*\\]", "g"), tt = new RegExp(Ge),
        nt = new RegExp("^" + Xe + "$"), rt = {
            ID: new RegExp("^#(" + Xe + ")"),
            CLASS: new RegExp("^\\.(" + Xe + ")"),
            TAG: new RegExp("^(" + Xe + "|[*])"),
        ...
        }, ot = /^(?:input|select|textarea|button)$/i, it = /^h\d$/i, at = /^[^{]+\{\s*\[native \w/,
        ut = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, st = /[+~]/, ct = /'|\\/g,
        lt = new RegExp("\\\\([\\da-f]{1,6}" + Ke + "?|(" + Ke + ")|.)", "ig"), ft = function (e, t, n) {
            var r = "0x" + t - 65536;
    ...
    for (J in Q = dt.support = {}, te = dt.isXML = function (e) {
        ...
        var t, s = e ? e.ownerDocument || e : _e, n = s.defaultView;
                ...
                return 1 === p && 0 === g ? function (e) {
                    ...
                    if (l) {
                        ...
                        if (s = [v ? l.firstChild : l.lastChild], v && d) {
                            for (u = (r = (o = l[Be] || (l[Be] = {}))[m] || [])[0] === De && r[1], a = r[0] === De && r[2], i = u && l.childNodes[u]; i = ++u && i && i[c] || (a = u = 0) || s.pop();) if (1 === i.nodeType && ++a && i === e) {
                                o[m] = [De, u, a];
                                break
                            }
                        } else if (d && (r = (e[Be] || (e[Be] = {}))[m]) && r[0] === De) a = r[1]; else for (; (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[Be] || (i[Be] = {}))[m] = [De, a]), i !== e));) ;
        ...
        pseudos: {
            not: pt(function (e) {
                ...
                return t = t.replace(lt, ft), function (e) {
                    return -1 < (e.textContent || e.innerText || ee(e)).indexOf(t)
                }
            }), lang: pt(function (n) {
                return nt.test(n || "") || dt.error("unsupported lang: " + n), n = n.replace(lt, ft).toLowerCase(), function (e) {
                    var t;
                    do {
    ...
    }).pseudos.nth = Z.pseudos.eq, {radio: !0, checkbox: !0, file: !0, password: !0, image: !0}) Z.pseudos[J] = ht(J);
    for (J in{submit: !0, reset: !0}) Z.pseudos[J] = vt(J);
    ...
    function wt(a, e, t) {
        var u = e.dir, s = t && "parentNode" === u, c = Oe++;
    ...
    function St(m, p, g, h, v, e) {
        return h && !h[Be] && (h = St(h)), v && !v[Be] && (v = St(v, e)), pt(function (e, t, n, r) {
            var o, i, a, u = [], s = [], c = t.length, l = e || function (e, t, n) {
                    ...
                    return n
                }(p || "*", n.nodeType ? [n] : n, []), f = !m || !e && p ? l : Et(l, u, m, n, r),
                d = g ? v || (e ? m : c || h) ? [] : t : f;
            if (g && g(f, d, n, r), h) for (o = Et(d, s), h(o, [], n, r), i = o.length; i--;) (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
            if (e) {
                if (v || m) {
                    if (v) {
    ...
    function kt(e) {
        ...
        }]; u < o; u++) if (t = Z.relative[e[u].type]) l = [wt(Nt(l), t)]; else {
            if ((t = Z.filter[e[u].type].apply(null, e[u].matches))[Be]) {
                for (n = ++u; n < o && !Z.relative[e[n].type]; n++) ;
                return St(1 < u && Nt(l), 1 < u && xt(e.slice(0, u - 1).concat({value: " " === e[u - 2].type ? "*" : ""})).replace(Je, "$1"), t, u < n && kt(e.slice(u, n)), n < o && kt(e = e.slice(n)), n < o && xt(e))
            }
            l.push(t)
        }
        return Nt(l)
    ...
    Ct.prototype = Z.filters = Z.pseudos, Z.setFilters = new Ct, ne = dt.tokenize = function (e, t) {
        ...
        if (!a) {
            ...
            (a = Ie(e, (h = i, y = 0 < (v = o).length, b = 0 < h.length, r = function (e, t, n, r, o) {
                ...
                if (s += c, y && c !== s) {
                    ...
                    if (e) {
                        if (0 < s) for (; c--;) l[c] || f[c] || (f[c] = Ve.call(r));
                        f = Et(f)
                    }
        ...
        var o, i, a, u, s, c = "function" == typeof e && e, l = !r && ne(e = c.selector || e);
        if (n = n || [], 1 === l.length) {
            ...
            for (o = rt.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !Z.relative[u = a.type]);) if ((s = Z.find[u]) && (r = s(a.matches[0].replace(lt, ft), st.test(i[0].type) && bt(t.parentNode) || t))) {
    ...
    var Tt = Array.isArray, At = function (e, t, n) {
            var r, o;
            if (!e) return 0;
            ...
            isArray: Tt, toArray: function (e) {
                var t, n, r = e;
                if (!Tt(e)) for (r = [], t = 0, n = e.length; t < n; t++) r[t] = e[t];
                return r
            }, each: At, map: function (n, r) {
                var o = [];
                ...
                return n
            }, findIndex: Rt, find: function (e, t, n) {
                var r = Rt(e, t, n);
                return -1 !== r ? e[r] : undefined
            }, last: function (e) {
                return e[e.length - 1]
            }
        }, _t = /^\s*|\s*$/g, Dt = function (e) {
            ...
            trim: Dt, isArray: Bt.isArray, is: Ot, toArray: Bt.toArray, makeMap: function (e, t, n) {
                var r;
                for (t = t || ",", "string" == typeof (e = e || []) && (e = e.split(t)), n = n || {}, r = e.length; r--;) n[e[r]] = {};
                return n
            }, each: Bt.each, map: Bt.map, grep: Bt.filter, inArray: Bt.indexOf, hasOwn: function (e, t) {
        ...
        }, It = document, Mt = Array.prototype.push, Ft = Array.prototype.slice,
        zt = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, Ut = Re.Event, qt = Lt.makeMap("children,contents,next,prev"),
        Vt = function (e) {
            return void 0 !== e
        }, Ht = function (e) {
            ...
            var o;
            if (Ht(t)) t = jt(t, an(e[0])); else if (t.length && !t.nodeType) {
                if (t = en.makeArray(t), r) for (o = t.length - 1; 0 <= o; o--) $t(e, t[o], n, r); else for (o = 0; o < t.length; o++) $t(e, t[o], n, r);
                return e
            }
        ...
        Gt = {"for": "htmlFor", "class": "className", readonly: "readOnly"}, Jt = {"float": "cssFloat"}, Qt = {},
        Zt = {}, en = function (e, t) {
            return new en.fn.init(e, t)
        }, tn = /^\s*|\s*$/g, nn = function (e) {
    ...
    en.fn = en.prototype = {
        constructor: en, selector: "", context: null, length: 0, init: function (e, t) {
            var n, r, o = this;
            if (!e) return o;
            ...
            if (Ht(e)) {
                ...
                if (n[1]) for (r = jt(e, an(t)).firstChild; r;) Mt.call(o, r), r = r.nextSibling; else {
            ...
            if (!1 !== t) for (n = en.unique(o.toArray().concat(en.makeArray(e))), o.length = n.length, r = 0; r < n.length; r++) o[r] = n[r]; else Mt.apply(o, en.makeArray(e));
            return o
        }, attr: function (t, n) {
            var e, r = this;
            ...
            if ("object" == typeof n) rn(n, function (e, t) {
                ...
                var e = this.style;
                if ((o = Zt[n]) && o.set) o.set(this, r); else {
                    try {
                        this.style[Jt[n] || n] = r
                    } catch (t) {
                    }
        ...
        }, push: Mt, sort: [].sort, splice: [].splice
    }, Lt.extend(en, {
        extend: Lt.extend,
    ...
    var un = function (e, t, n) {
        ...
        var o = [];
        for (r instanceof en && (r = r[0]); e; e = e[t]) if (!n || e.nodeType === n) {
            if (r !== undefined) {
                if (e === r) break;
    ...
    var fn, dn = function (e) {
            ...
            nu: gn, detect: function (e, t) {
                var n = String(t).toLowerCase();
                return 0 === e.length ? pn() : mn(e, n)
            }, unknown: pn
        }, vn = "Firefox", yn = function (e, t) {
            return function () {
                return t === e
            }
        }, bn = function (e) {
            ...
            unknown: function () {
                return bn({current: undefined, version: hn.unknown()})
            },
            nu: bn,
        ...
        }, xn = "Windows", wn = "Android", Nn = "Solaris", En = "FreeBSD", Sn = function (e, t) {
            return function () {
                return t === e
            }
        }, kn = function (e) {
            ...
            unknown: function () {
                return kn({current: undefined, version: hn.unknown()})
            },
            nu: kn,
        ...
        }, On = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, Pn = function (t) {
            return function (e) {
                return _n(e, t)
            }
        }, Ln = [{
            ...
            name: "Chrome", versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, On], search: function (e) {
        ...
        }, {name: "Opera", versionRegexes: [On, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: Pn("opera")}, {
            name: "Firefox",
            versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/],
            search: Pn("firefox")
        }, {
            name: "Safari", versionRegexes: [On, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
        ...
        }, {name: "Android", search: Pn("android"), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/]}, {
            name: "OSX",
            search: Pn("os x"),
        ...
        Mn = {browsers: V.constant(Ln), oses: V.constant(In)}, Fn = function (e) {
            var t, n, r, o, i, a, u, s, c, l, f, d = Mn.browsers(), m = Mn.oses(), p = Rn(d, e).fold(Cn.unknown, Cn.nu),
            ...
            fromHtml: function (e, t) {
                ...
                return Un(n)
            }, fromDom: Un, fromPoint: function (e, t, n) {
                return A.from(e.dom().elementFromPoint(t, n)).map(Un)
            }
        }, Vn = 8, Hn = 9, jn = 1, $n = 3, Wn = function (e) {
        ...
        }, Yn = Xn(jn), Gn = Xn($n), Jn = Xn(Hn), Qn = {
            name: Wn, type: Kn, value: function (e) {
                return e.dom().nodeValue
            }, isElement: Yn, isText: Gn, isDocument: Jn, isComment: function (e) {
            ...
            }, each: er, map: function (e, r) {
                return tr(e, function (e, t, n) {
                    return {k: t, v: r(e, t, n)}
                })
            }, mapToArray: nr, tupleMap: tr, find: function (e, t) {
                for (var n = Zn(e), r = 0, o = n.length; r < o; r++) {
                    var i = n[r], a = e[i];
                    if (t(a, i, e)) return A.some(a)
                }
                return A.none()
            }, keys: Zn, values: rr, size: function (e) {
                return rr(e).length
            }
        }, ir = function (e, t, n) {
            ...
            }, set: ar, setAll: function (e, t) {
                var n = e.dom();
                or.each(t, function (e, t) {
                    ir(n, t, e)
                })
            }, get: ur, has: sr, remove: function (e, t) {
            ...
            body: lr, getBody: fr, inBody: function (e) {
            ...
            sort: Cr, reqMessage: function (e, t) {
            ...
            immutable: function () {
                ...
                return xr.validateStrArr("required", o), xr.validateStrArr("optional", i), xr.checkDupes(a), function (t) {
                    var n = or.keys(t);
            ...
            owner: Pr, defaultView: function (e) {
                ...
                for (var n = E.isFunction(t) ? t : V.constant(!1), r = e.dom(), o = []; null !== r.parentNode && r.parentNode !== undefined;) {
                    var i = r.parentNode, a = qn.fromDom(i);
            ...
            }, prevSibling: Ir, offsetParent: function (e) {
                var t = e.dom();
                return A.from(t.offsetParent).map(qn.fromDom)
            }, prevSiblings: function (e) {
                return H.reverse(Nr(e, Ir))
            }, nextSibling: Mr, nextSiblings: function (e) {
                return Nr(e, Mr)
            }, children: Fr, child: zr, firstChild: function (e) {
                return zr(e, 0)
        ...
        }, Vr = zn.detect().browser, Hr = function (e) {
            ...
            return function () {
                var e = Array.prototype.slice.call(arguments), t = this;
                setTimeout(function () {
                    n.apply(t, e)
                }, 0)
            }
            ...
            return {
                is: V.never, isValue: V.never, isError: V.always, getOr: V.identity, getOrThunk: function (e) {
                    return e()
                }, getOrDie: function () {
                    ...
                    return eo(n)
                }, each: V.noop, bind: function (e) {
                    return eo(n)
                }, exists: V.never, forall: V.always, toOption: A.none
            }
        }, to = {value: Zr, error: eo};
    ...
    var ro, oo, io, ao = function (t) {
        ...
        }, wo = yo(3), No = yo(8), Eo = yo(9), So = Co("br"), ko = xo("true"), To = xo("false"), Ao = {
            isText: wo,
            isElement: bo,
            isComment: No,
            isDocument: Eo,
    ...
    var zo = function (e, t) {
            ...
            }, encodeNumeric: Uo, encodeNamed: qo, getEncodeFunc: function (e, t) {
                var n = Fo(t) || ro, r = Do(e.replace(/\+/g, ","));
        ...
        }, Ho = {}, jo = {}, $o = Lt.makeMap, Wo = Lt.each, Ko = Lt.extend, Xo = Lt.explode, Yo = Lt.inArray,
        Go = function (e, t) {
    ...
    function Zo(i) {
        var e, t, n, r, o, a, u, s, c, l, f, d, m, N = {}, p = {}, E = [], g = {}, h = {}, v = function (e, t, n) {
            var r = i[e];
        ...
        var S = function (e) {
            ...
            Ho[i.schema] = null, e && Wo(Go(e, ","), function (e) {
                var t, n, r = o.exec(e);
                r && (n = r[1], t = n ? p[r[2]] : p[r[2]] = {"#comment": {}}, t = p[r[2]], Wo(Go(r[3], "|"), function (e) {
                    "-" === n ? delete t[e] : t[e] = {}
                }))
            })
        }, w = function (e) {
        ...
        return i.valid_elements ? b(i.valid_elements) : (Wo(n, function (e, t) {
            N[t] = {attributes: e.attributes, attributesOrder: e.attributesOrder}, p[t] = e.children
            ...
            children: p, elements: N, getValidStyles: function () {
                return e
                ...
                return g
            }, addValidElements: y, setValidElements: b, addCustomElements: C, addValidChildren: x
        }
    }
    ...
    function ti(b, e) {
        ...
        return {
            toHex: function (e) {
                ...
                var t, n, r, o, i, a, u, s, c = {}, l = b.url_converter, f = b.url_converter_scope || this,
                    d = function (e, t, n) {
                        var r, o, i, a;
    ...
    var ni, ri = Lt.each, oi = Lt.grep, ii = ge.ie, ai = /^([a-z0-9],?)+$/i, ui = /^[ \t\r\n]*$/,
        si = function (n, r, o) {
    ...
    function fi(a, u) {
        var s, c = this;
        void 0 === u && (u = {});
        var r = {}, i = window, o = {}, t = 0, e = function (m, e) {
                var p, g = 0, h = {};
                ...
                var v = function (e) {
                    ...
                    if (e = Lt._addCacheSuffix(e), h[e] ? a = h[e] : (a = {
                        ...
                        if (a.status = 1, (o = m.createElement("link")).rel = "stylesheet", o.type = "text/css", o.id = "u" + g++, o.async = !1, o.defer = !1, i = (new Date).getTime(), "onload" in o && !((d = navigator.userAgent.match(/WebKit\/(\d*)/)) && parseInt(d[1], 10) < 536)) o.onload = l, o.onerror = s; else {
            ...
            }(a), l = [], f = u.schema ? u.schema : Zo({}),
            d = ti({url_converter: u.url_converter, url_converter_scope: u.url_converter_scope}, u.schema),
            m = u.ownEvents ? new Re(u.proxy) : Re.Event, n = f.getBlockElements(),
            p = en.overrideDefaults(function () {
                return {context: a, element: q.getRoot()}
            }), g = function (e) {
            ...
            }, D = Vo.decode, O = Vo.encodeAllRaw, P = function (e, t) {
                var n = h(e);
                ...
                getRect: function (e) {
                    var t, n;
                    return e = g(e), t = x(e), n = N(e), {x: t.x, y: t.y, w: n.w, h: n.h}
                },
                getSize: N,
    ...
    var di = fi, mi = di.DOM, pi = Lt.each, gi = Lt.grep, hi = function (e) {
        ...
        this.isDone = function (e) {
            ...
            a.push({success: e, failure: r, scope: t || this}), (s = function () {
                var e = gi(n);
    ...
    var xi, wi = "\ufeff", Ni = function (e) {
            return e === wi
        }, Ei = wi, Si = function (e) {
            return e.replace(new RegExp(wi, "g"), "")
        }, ki = Ao.isElement, Ti = Ao.isText, Ai = function (e) {
            ...
            var t, n
        }, Fi = Ao.isContentEditableTrue, zi = Ao.isContentEditableFalse, Ui = Ao.isBr, qi = Ao.isText,
        Vi = Ao.matchNodeNames("script style textarea"),
        Hi = Ao.matchNodeNames("img input textarea hr iframe video audio object"), ji = Ao.matchNodeNames("table"),
        $i = Bi, Wi = function (e) {
        ...
        }, ca = Ao.isElement, la = Wi, fa = Ao.matchStyleValues("display", "block table"),
        da = Ao.matchStyleValues("float", "left right"), ma = ua.and(ca, la, ua.negate(da)),
        pa = ua.negate(Ao.matchStyleValues("white-space", "pre pre-line pre-wrap")), ga = Ao.isText, ha = Ao.isBr,
        va = di.nodeIndex, ya = na, ba = function (e) {
            ...
            if (ca(e.container())) if (e.isAtEnd()) n = ya(e.container(), e.offset()), ga(n) && i(n, n.data.length), ma(n) && !ha(n) && o(Sa(Ea(n), !1)); else {
    ...
    function Ta(t, n, e) {
        ...
        return {
            container: ua.constant(t), offset: ua.constant(n), toRange: function () {
                var e;
    ...
    var Aa, Ra, Ba = Ta, _a = Ao.isElement, Da = Ao.isText, Oa = function (e) {
        var t = e.parentNode;
        t && t.removeChild(e)
    }, Pa = function (e, t) {
    ...
    }, Xa = Ao.isContentEditableTrue, Ya = Ao.isContentEditableFalse, Ga = function (e, t, n, r, o) {
        ...
        var r = Cs(1, e.getBody(), t), o = Ba.fromRangeStart(r), i = o.getNode();
    ...
    var eu, tu, nu = function (e, t) {
            ...
            for (var o, i, a, u, s, c, l = js(n), f = r, d = []; f && (s = l, c = f, o = t === eu.Forwards ? s.next(c) : s.prev(c));) {
                if (Ao.isBr(o.getNode(!1))) return t === eu.Forwards ? {
                    ...
                    breakType: Aa.Br,
                    breakAt: A.some(o)
                } : {positions: nu(t, d), breakType: Aa.Br, breakAt: A.some(o)};
                if (o.isVisible()) {
                    if (e(f, o)) {
                        var m = (i = t, a = f, u = o, Ao.isBr(u.getNode(i === eu.Forwards)) ? Aa.Br : !1 === ps(a, u) ? Aa.Block : Aa.Wrap);
                        return {positions: nu(t, d), breakType: m, breakAt: A.some(o)}
                    }
                    d.push(o), f = o
                } else f = o
            }
            return {positions: nu(t, d), breakType: Aa.Eol, breakAt: A.none()}
        }, ou = function (n, r, o, e) {
        ...
        }, uu = V.curry(ru, Ta.isAbove, -1), su = V.curry(ru, Ta.isBelow, 1), cu = V.curry(ou, -1, uu),
        lu = V.curry(ou, 1, su), fu = function (e, t) {
            return Br.all(t, e)
            ...
            }, append: Mu, appendAt: function (e, t, n) {
        ...
        }, zu = zn.detect().browser, Uu = function () {
        ...
        }, Hu = ua.curry(Vu, uu), ju = ua.curry(Vu, su), $u = function (e, t, n, r) {
            ...
            var o, i, a, u, s, c, l = e.selection.getRng(), f = Ba.fromRangeStart(l), d = e.getBody();
            if (!t && Hu(r, f)) {
        ...
        }, Qu = Ao.isContentEditableFalse, Zu = function (e, t, n) {
            ...
            var t, s, c = Ju(A.none()), l = function () {
                !function (e) {
                    var t, n, r, o, i;
        ...
        rs = Ao.matchStyleValues("display", "block table table-cell table-caption list-item"), os = Bi, is = Ai,
        as = ua.curry, us = Ao.isElement, ss = Wi, cs = function (e) {
            return 0 < e
        }, ls = function (e) {
            return e < 0
        }, fs = function (e, t) {
            ...
            return null
        }, ys = as(hs, !0), bs = as(hs, !1), Cs = function (e, t, n) {
            var r, o, i, a, u = as(vs, !0, t), s = as(vs, !1, t);
        ...
        }, Ss = as(xs, 0), ks = as(xs, -1), Ts = as(ws, 0), As = as(ws, -1);
    (tu = eu || (eu = {}))[tu.Backwards = -1] = "Backwards", tu[tu.Forwards = 1] = "Forwards";
    var Rs, Bs, _s, Ds, Os, Ps = Ao.isContentEditableFalse, Ls = Ao.isText, Is = Ao.isElement, Ms = Ao.isBr, Fs = Wi,
        zs = function (e) {
            return Hi(e) || !!Ki(t = e) && !0 !== Bt.reduce(t.getElementsByTagName("*"), function (e, t) {
                return e || Fi(t)
            }, !1);
            var t
        }, Us = Xi, qs = function (e, t) {
            ...
            var n = Ba.after(e), r = js(t).prev(n);
            ...
            var n, r, a, u, s, c, l, f, d, m, p, g, h, v, y, b, C, x, w,
                ...
                E = Xs(o, i.startContainer), S = Ks($s(N.firstChild)), k = o.getRoot(), T = function (e) {
                    var t = Ba.fromRangeStart(i), n = js(o.getRoot()), r = 1 === e ? n.prev(t) : n.next(t);
            ...
            return !!Xs(e, t)
        }, ec = Ao.isText, tc = Ao.isBogus, nc = di.nodeIndex, rc = function (e) {
            var t = e.parentNode;
            return tc(t) ? rc(t) : t
        }, oc = function (e) {
            ...
            return n = t.container(), r = t.offset(), ec(n) ? o = function (e, t) {
                for (; (e = e.previousSibling) && ec(e);) t += e.data.length;
                return t
        ...
        }, cc = Ao.isContentEditableFalse, lc = function (e, t, n, r, o) {
            ...
            if (cc(r) || "IMG" === o) return {name: o, index: dc(n.dom, o, r)};
            ...
            if ("IMG" === u) return {name: u, index: dc(n, u, a)};
            ...
            return r.insertNode(l), fc(l.previousSibling), e.moveToBookmark({id: o, keep: 1}), {id: o}
        }, bc = {
            getBookmark: function (e, t, n) {
                ...
                }) : t ? {rng: e.getRng()} : yc(e, !1);
                var r, o
            }, getUndoBookmark: V.curry(hc, V.identity, !0), getPersistentBookmark: yc
        }, Cc = "_mce_caret", xc = function (e) {
            ...
            var t = fu(e, "br"), n = H.filter(function (e) {
    ...
    var $c = function (a) {
        var u = Ba.fromRangeStart(a), s = Ba.fromRangeEnd(a), c = a.commonAncestorContainer;
    ...
    }, Kc = Ao.matchNodeNames("td th"), Xc = function (o, e, t) {
        var n, r, i, a, u, s, c, l, f, d, m, p, g = o.schema.getTextInlineElements(), h = o.selection, v = o.dom;
        if (/^ | $/.test(e) && (e = function (e) {
        ...
        }(e)), n = o.parser, p = t.merge, r = jc({validate: o.settings.validate}, o.schema), m = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', s = {
            content: e,
            format: "html",
            selection: !0,
            paste: t.paste
            ...
            var E, S, k, T = {context: (i = h.getNode()).nodeName.toLowerCase(), data: t.data, insert: !0};
            ...
            } else e = r.serialize(u), function (e, t, n) {
            ...
            !function () {
                ...
                if (e) {
                    ...
                    }(l)) ? v.add(n, v.create("br", {"data-mce-bogus": "1"})) : (l = r, v.remove(n))), h.setRng(l)
                }
    ...
    var Jc = function (e, t, n) {
            ...
            first: function (e) {
                return Zc(dr.body(), e)
            }, ancestor: Jc, closest: function (e, t, n) {
            ...
            }, child: Qc, descendant: Zc
        }, tl = wr.immutable("sections", "settings"), nl = zn.detect().deviceType.isTouch(),
        rl = ["lists", "autolink", "autosave"], ol = {theme: "mobile"}, il = function (e) {
            var t = E.isArray(e) ? e.join(" ") : e, n = H.map(E.isString(t) ? t.split(" ") : [], Dn);
        ...
        }, ll = V.curry(cl, E.isString), fl = function (e, t, n, r) {
            ...
            return sa([Ka.firstPositionIn(u), Ka.lastPositionIn(u)], function (e, t) {
                var n = pl.normalizePosition(!0, e), r = pl.normalizePosition(!1, t), o = pl.normalizePosition(!1, a);
            ...
            var n
        }, Sl = Ao.hasAttribute("data-mce-bookmark"), kl = Ao.hasAttribute("data-mce-bogus"),
        Tl = Ao.hasAttributeValue("data-mce-bogus", "all"), Al = function (e) {
            return function (e) {
                var t, n, r = 0;
                if (El(e, e)) return !1;
                ...
                t = new no(n, e);
                do {
                    if (Tl(n)) n = t.next(!0); else if (kl(n)) n = t.next(); else if (Ao.isBr(n)) r++, n = t.next(); else {
                        if (El(e, n)) return !1;
                        n = t.next()
                    }
                } while (n);
        ...
        }, Rl = wr.immutable("block", "position"), Bl = wr.immutable("from", "to"), _l = function (e, t) {
            var n = qn.fromDom(e), r = qn.fromDom(t.container());
            return gl(n, r).map(function (e) {
                return Rl(e, t)
            })
        }, Dl = function (o, i, e) {
            var t = _l(o, Ba.fromRangeStart(e)), n = t.bind(function (e) {
            ...
            var n = qn.fromDom(t), r = V.curry(Or.eq, e);
            ...
            var n, r, o, t, i = qn.fromDom(e.getBody()), a = e.selection.getRng();
        ...
        }, Gl = Yl([{remove: ["element"]}, {moveToElement: ["element"]}, {moveToPosition: ["position"]}]),
        Jl = function (e, t, n, r) {
            var o = r.getNode(!1 === t);
            ...
            return Ao.isContentEditableTrue(n) && e.dom.isBlock(n) && e.dom.isEmpty(n) && (t = e.dom.create("br", {"data-mce-bogus": "1"}), e.dom.setHTML(n, ""), n.appendChild(t), e.selection.setRng(Ba.before(t).toRange())), !0
        }, gf = Ao.isText, hf = function (e) {
        ...
        }, Cf = V.curry(bf, !0), xf = V.curry(bf, !1), wf = function (e, t) {
            ...
            return A.none()
        }, kf = Yl([{before: ["element"]}, {start: ["element"]}, {end: ["element"]}, {after: ["element"]}]),
        Tf = function (e, t) {
            var n = ms(t, e);
            return n || e
        }, Af = function (e, t, n) {
            var r = pl.normalizeForwards(n), o = Tf(t, r.container());
            ...
            var r = pl.normalizeBackwards(n), o = Tf(t, r.container());
            return pl.findRootInline(e, o, r).fold(function () {
            ...
            var e = pl.normalizePosition(a, c), l = Lf(u, s, e);
        ...
        }, Hf = Lf, jf = Vf, $f = (V.curry(Vf, !1), V.curry(Vf, !0), Ff), Wf = function (e) {
            ...
            var n = t.selection.getRng(), r = e ? Ba.fromRangeEnd(n) : Ba.fromRangeStart(n);
            ...
            }, moveNextWord: V.curry(ed, !0), movePrevWord: V.curry(ed, !1), setupSelectedState: function (a) {
                var u = Ju(null), s = V.curry(pl.isInlineTarget, a);
            ...
            var u = r.getBody(), s = V.curry(pl.isInlineTarget, r);
            ...
            var e, t, a = (e = n.getBody(), t = o.container(), ms(t, e) || e), u = V.curry(pl.isInlineTarget, n),
                s = Hf(u, a, o);
            return s.bind(function (e) {
                ...
                var t = Ka.navigate(i, a, o), e = t.bind(function (e) {
                    return Hf(u, a, e)
                });
                return s.isSome() && e.isSome() ? pl.findRootInline(u, a, o).map(function (e) {
                    return o = e, !!sa([Ka.firstPositionIn(o), Ka.lastPositionIn(o)], function (e, t) {
                        var n = pl.normalizePosition(!0, e), r = pl.normalizePosition(!1, t);
            ...
            return !1
        }, ad = wr.immutable("start", "end"), ud = wr.immutable("rng", "table", "cells"),
        sd = Yl([{removeTable: ["element"]}, {emptyCells: ["cells"]}]), cd = function (e, t) {
            ...
            var t = cd(e.startContainer, r), n = cd(e.endContainer, r);
            ...
            var n, r, o, i, a, u = qn.fromDom(e.selection.getStart(!0)), s = Ad(e);
            ...
            getFontSize: qd("font-size"), getFontFamily: V.compose(function (e) {
                return e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")
            }, qd("font-family")), toPt: function (e, t) {
            ...
            e.formatter.toggle("fontname", {value: $d(e, t)}), e.nodeChanged()
        }, Kd = function (t) {
            ...
            e.formatter.toggle("fontsize", {value: $d(e, t)}), e.nodeChanged()
        }, Yd = function (t) {
            return jd(t).fold(function () {
                return Hd(t).map(function (e) {
            ...
            for (var r = new no(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot()); t = r[n ? "prev" : "next"]();) if (Ao.isBr(t)) return !0
            ...
            var o, i, a, u, s, c, l, f, d, m, p = e.getRoot(), g = !1;
            ...
            normalize: function (e, t) {
                var n = t.collapsed, r = t.cloneRange(), o = Ta.fromRangeStart(t);
            ...
            "LI" !== d || m || (l = f), s && 3 === s.nodeType && u >= s.nodeValue.length && (function (e, t, n) {
                for (var r, o = new no(t, n), i = e.getNonEmptyElements(); r = o.next();) if (i[r.nodeName.toLowerCase()] || 0 < r.length) return !0
            ...
            insert: function (e, t) {
                var n, r, o,
                    i = (n = e, r = V.curry(pl.isInlineTarget, n), o = Ba.fromRangeStart(n.selection.getRng()), Hf(r, n.getBody(), o).filter(fm));
                i.isSome() ? i.each(V.curry(dm, e)) : am(e, t)
            }
        }, pm = Yl([{before: ["element"]}, {on: ["element", "offset"]}, {after: ["element"]}]),
        gm = (pm.before, pm.on, pm.after, function (e) {
            return e.fold(V.identity, V.identity, V.identity)
        }),
        hm = Yl([{domRange: ["rng"]}, {relative: ["startSitu", "finishSitu"]}, {exact: ["start", "soffset", "finish", "foffset"]}]),
        vm = wr.immutable("start", "soffset", "finish", "foffset"), ym = {
            domRange: hm.domRange, relative: hm.relative, exact: hm.exact, exactFromRange: function (e) {
                return hm.exact(e.start(), e.soffset(), e.finish(), e.foffset())
            }, range: vm, getWin: function (e) {
                var t = e.match({
                    domRange: function (e) {
        ...
        }, bm = zn.detect().browser, Cm = function (e, t) {
            ...
            store: function (e) {
                ...
                var n = qn.fromDom(e.getBody()), r = (Em(e) ? A.from(t) : A.none()).map(Sm).filter(Nm(n));
                e.bookmark = r.isSome() ? r : e.bookmark
            }, readRange: km, restore: function (t) {
                Bm(t).each(function (e) {
                    t.selection.setRng(e)
                })
            }, getRng: Bm, getBookmark: Tm, validate: Am
        }, Dm = function (e, t) {
        ...
        }, Om = Lt.each, Pm = Lt.extend, Lm = Lt.map, Im = Lt.inArray;
    ...
    var Fm = Lt.makeMap("focus blur focusin focusout click dblclick mousedown mouseup mousemove mouseover beforepaste paste cut copy selectionchange mouseout mouseenter mouseleave wheel keydown keypress keyup input contextmenu dragstart dragend dragover draggesture dragdrop drop drag submit compositionstart compositionend compositionupdate touchstart touchmove touchend", " "),
        zm = function (a) {
            ...
            var r = function (e, t, n, r) {
                var o, i, a;
                if (!1 === t && (t = f), t) for (t = {func: t}, r && Lt.extend(t, r), a = (i = e.toLowerCase().split(" ")).length; a--;) e = i[a], (o = l[e]) || (o = l[e] = [], s(e, !0)), n ? o.unshift(t) : o.push(t);
                return c
            }, m = function (e, t) {
                var n, r, o, i, a;
    ...
    var Um, qm = function (n) {
        ...
        fire: function (e, t, n) {
            ...
            if (t = qm(this).fire(e, t, n), !1 !== n && this.parent) for (var r = this.parent(); r && !t.isPropagationStopped();) r.fire(e, t, !1), r = r.parent();
            return t
        }, on: function (e, t, n) {
        ...
        if (i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed) if (e = jm(i, a), i.settings.event_root) {
    ...
    }, Km = Wm = Lt.extend({}, Vm, Wm), Xm = function (e, t, n) {
        try {
    ...
    }, Jm = Lt.each, Qm = Lt.explode, Zm = {f9: 120, f10: 121, f11: 122}, ep = Lt.makeMap("alt,ctrl,shift,meta,access");
    ...
    function tp(i) {
        var a = {}, r = [], u = function (e) {
            ...
            return (o = Lt.map(Qm(e, ">"), u))[o.length - 1] = Lt.extend(o[o.length - 1], {
                func: n,
                scope: r || i
            }), Lt.extend(o[0], {desc: i.translate(t), subpatterns: o.slice(1)})
        }, o = function (e, t) {
    ...
    var np = function (e) {
        ...
        }, dp = cp, mp = function (e, t) {
            return t.dom()[e]
        }, pp = function (e, t) {
            return parseInt(yr(t, e), 10)
        }, gp = V.curry(mp, "clientWidth"), hp = V.curry(mp, "clientHeight"), vp = V.curry(pp, "margin-top"),
        yp = V.curry(pp, "margin-left"), bp = {
            isXYInContentArea: function (e, t, n) {
                var r, o, i, a, u, s, c, l, f, d, m = qn.fromDom(e.getBody()), p = e.inline ? m : qr.documentElement(m),
    ...
    var wp = Ci.PluginManager, Np = function (e, t) {
        var n = function (e, t) {
            for (var n in wp.urls) if (wp.urls[n] + "/plugin" + t + ".js" === e) return n;
            return null
        }(t, e.suffix);
        ...
        }, displayError: Sp, initError: function (e) {
            for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
            var r = window.console;
            r && (r.error ? r.error.apply(r, arguments) : r.log.apply(r, arguments))
        }
    }, Tp = Ci.PluginManager, Ap = Ci.ThemeManager;
    ...
    function Bp(u, s) {
        ...
        return s = Lt.extend({credentials: !1, handler: n}, s), {
            upload: function (e, t) {
    ...
    }, Fp = Lp, zp = 0, Up = function (e) {
        return (e || "blobid") + zp++
    }, qp = function (n, r, o, t) {
        var i, a;
        0 !== r.src.indexOf("blob:") ? (i = Fp(r.src).data, (a = n.findFirst(function (e) {
            return e.base64() === i
        })) ? o({image: r, blobInfo: a}) : Ip(r.src).then(function (e) {
            a = n.create(Up(), e, i), n.add(a), o({image: r, blobInfo: a})
        }, function (e) {
            t(e)
        })) : (a = n.getByUri(r.src)) ? o({image: r, blobInfo: a}) : Ip(r.src).then(function (t) {
            Mp(t).then(function (e) {
                i = Fp(e).data, a = n.create(Up(), t, i), n.add(a), o({image: r, blobInfo: a})
            })
        }, function (e) {
            t(e)
        })
    ...
    function $p(u) {
        var n, o, i, t, e, a, r, s, c, l, f = (n = [], o = ua.constant, i = function (e) {
            ...
            create: function (e, t, n, r) {
                return i("object" == typeof e ? e : {id: e, name: r, blob: t, base64: n})
            }, add: function (e) {
                t(e.id()) || n.push(e)
            }, get: t = function (t) {
                return e(function (e) {
        ...
        }), d = u.settings, m = (s = {}, c = function (e, t) {
        ...
        return u.on("setContent", function () {
            ...
            blobCache: f, uploadImages: C, uploadImagesAuto: x, scanForImages: N, destroy: function () {
    ...
    var Wp = function (e, t) {
        ...
        var t, n, r, o, i, a, u, s, c, l, f, d = e.settings, m = e.dom, p = e.selection, g = e.schema,
            h = g.getBlockElements(), v = p.getStart(), y = e.getBody();
        if (f = d.forced_root_block, v && Ao.isElement(v) && f && (l = y.nodeName.toLowerCase(), g.isValidChild(l, f.toLowerCase()) && (b = h, C = y, x = v, !H.exists(Il(qn.fromDom(x), qn.fromDom(C)), function (e) {
            ...
            var b, C, x, w, N;
            for (n = (t = p.getRng()).startContainer, r = t.startOffset, o = t.endContainer, i = t.endOffset, c = dp(e), v = y.firstChild; v;) if (w = h, N = v, Ao.isText(N) || Ao.isElement(N) && !Wp(w, N) && !Bc.isBookmarkNode(N)) {
                if (Kp(h, v)) {
    ...
    var Jp, Qp, Zp = function (e) {
        ...
        var n, r, o, i, a, u
    }, tg = Ao.isContentEditableFalse, ng = Ao.isContentEditableTrue, rg = function (e) {
        ...
        t = di.DOM, a = document, n = og(c, e), g = c, h = e, v = Ce.throttle(function (e, t) {
            ...
            var t, n, r, o, i, a, u, s, c, l, f, d,
                m = Math.max(Math.abs(e.screenX - g.screenX), Math.abs(e.screenY - g.screenY));
            if (g.element && !g.dragging && 10 < m) {
                if (h.fire("dragstart", {target: g.element}).isDefaultPrevented()) return;
                g.dragging = !0, h.focus()
            }
            if (g.dragging) {
                var p = (f = g, {pageX: (d = eg(h, e)).pageX - f.relX, pageY: d.pageY + 5});
    ...
    var lg = function (o, i, a, e, u, t) {
        var n, s, c = 0, l = [], r = function (e) {
            var t, n, r;
            for (r = cg([e]), -1 === o && (r = r.reverse()), t = 0; t < r.length; t++) if (n = r[t], !a(n, s)) {
                if (0 < l.length && i(n, Bt.last(l)) && c++, n.line = c, u(n)) return !0;
                l.push(n)
            }
        };
        return (s = Bt.last(t.getClientRects())) && (r(n = t.getNode()), function (e, t, n, r) {
            for (; r = ds(r, e, Xi, t);) if (n(r)) return
        }(o, e, r, n)), l
    }, fg = V.curry(lg, Jp.Up, Zi, ea), dg = V.curry(lg, Jp.Down, ea, Zi), mg = function (n) {
        return function (e) {
            return t = n, e.line > t;
            var t
        }
    ...
    }, gg = Ao.isContentEditableFalse, hg = ds, vg = function (e, t) {
        ...
        for (; r = hg(r, e, Xi, t);) if (n(r)) return
    }, wg = function (e, t, n) {
    ...
    }, Tg = Ao.isContentEditableTrue, Ag = Ao.isContentEditableFalse, Rg = ks, Bg = Ss, _g = function (e, t) {
        ...
        var g, e, t, a = p.getBody(), o = es(p.getBody(), function (e) {
            return p.dom.isBlock(e)
        }, function () {
            return dp(p)
        }), h = "sel-" + p.dom.uniqueId(), u = function (e) {
            ...
            var n, r, o, i, a, u, s, c, l, f, d = p.$, m = p.dom;
            if (!e) return null;
            if (e.collapsed) {
                if (!b(e)) if (!1 === t) {
        ...
        return ge.ceFalse && (function () {
            ...
            var n, r, i = function (e, t) {
                var n, r, o = p.dom.getParent(e, p.dom.isBlock), i = p.dom.getParent(t, p.dom.isBlock);
                return !(!o || !p.dom.isChildOf(o, i) || !1 !== Ag(_g(p, o))) || o && (n = o, r = i, !(p.dom.getParent(n, p.dom.isBlock) === p.dom.getParent(r, p.dom.isBlock))) && function (e) {
                    ...
                    var n = Ba.before(e.firstChild), r = t.next(n);
                    return r && !Bg(r) && !Rg(r)
                }(o)
            };
            r = !1, (n = p).on("touchstart", function () {
                ...
                var t, n = e.target;
                if ((n === a || "HTML" === n.nodeName || p.dom.isChildOf(n, a)) && !1 !== bp.isXYInContentArea(p, e.clientX, e.clientY)) if (t = _g(p, n)) Ag(t) ? (e.preventDefault(), c(Ja(p, t))) : (l(), Tg(t) && e.shiftKey || Ng(e.clientX, e.clientY, p.selection.getRng()) || p.selection.placeCaretAt(e.clientX, e.clientY)); else if (!1 === ts(n)) {
                    l(), C();
    ...
    function Mg(z, U) {
        ...
        var q = z.comment ? z.comment : t, V = z.cdata ? z.cdata : t, H = z.text ? z.text : t,
            j = z.start ? z.start : t, $ = z.end ? z.end : t, W = z.pi ? z.pi : t, K = z.doctype ? z.doctype : t;
        return {
            parse: function (e) {
                var t, n, r, c, o, i, a, l, u, s, f, d, m, p, g, h, v, y, b, C, x, w, N, E, S, k, T, A, R, B = 0,
                    _ = [], D = 0, O = Vo.decode, P = Lt.makeMap("src,href,data,background,formaction,poster"),
                    L = /((java|vb)script|mhtml):/i, I = /^data:/i, M = function (e) {
                        var t, n;
                        ...
                        l && (t in P || 0 === t.indexOf("on")) || (c.map[t] = n, c.push({name: t, value: n}))
                    };
                for (S = new RegExp("<(?:(?:!--([\\w\\W]*?)--\x3e)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)>)|(?:([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), k = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, s = U.getShortEndedElements(), E = z.self_closing_elements || U.getSelfClosingElements(), f = U.getBoolAttrs(), m = z.validate, u = z.remove_internals, R = z.fix_self_closing, T = U.getSpecialElements(), N = e + ">"; t = S.exec(N);) {
                    if (B < t.index && H(O(e.substr(B, t.index - B))), n = t[6]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), M(n); else if (n = t[7]) {
                        ...
                        if (":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), d = n in s, R && E[n] && 0 < _.length && _[_.length - 1].name === n && M(n), !m || (p = U.getElementRule(n))) {
                            if (g = !0, m && (y = p.attributes, b = p.attributePatterns), (v = t[8]) ? ((l = -1 !== v.indexOf("data-mce-type")) && u && (g = !1), (c = []).map = {}, v.replace(k, F)) : (c = []).map = {}, m && !l) {
                                if (C = p.attributesRequired, x = p.attributesDefault, w = p.attributesForced, p.removeEmptyAttrs && !c.length && (g = !1), w) for (o = w.length; o--;) a = (h = w[o]).name, "{$uid}" === (A = h.value) && (A = "mce_" + D++), c.map[a] = A, c.push({
                                    name: a,
                                    value: A
                                });
                                if (x) for (o = x.length; o--;) (a = (h = x[o]).name) in c.map || ("{$uid}" === (A = h.value) && (A = "mce_" + D++), c.map[a] = A, c.push({
                                    name: a,
                                    value: A
                                }));
                                if (C) {
                                    for (o = C.length; o-- && !(C[o] in c.map);) ;
                                    -1 === o && (g = !1)
                                }
                        ...
                        d || (v && v.indexOf("/") === v.length - 1 ? g && $(n) : _.push({name: n, valid: g}))
    ...
    var Fg = Mg, zg = function (e, t) {
        ...
        return Si(l)
    }, Ug = {trimExternal: zg, trimInternal: zg}, qg = 0, Vg = 2, Hg = 1, jg = function (p, g) {
        var e = p.length + g.length + 2, h = new Array(e), v = new Array(e), c = function (e, t, n, r, o) {
            var i = l(e, t, n, r);
    ...
    }, Jg = Gg, Qg = function (e, t) {
        var n = qr.owner(e).dom(), r = qn.fromDom(n.createDocumentFragment()), o = Yg(t, n);
        ...
        createFragmentedLevel: Zg, createCompleteLevel: eh, createFromEditor: function (n) {
            var e, t, r;
            ...
            "fragmented" === t.type ? Xg(t.fragments, e.getBody()) : e.setContent(t.content, {format: "raw"}), e.selection.moveToBookmark(n ? t.beforeBookmark : t.bookmark)
        }, isEq: function (e, t) {
    ...
    function oh(u) {
        ...
        return u.on("init", function () {
            ...
            data: l, typing: !1, beforeChange: function () {
                ...
                var e;
                return o.typing && (o.add(), o.typing = !1, i(!1)), 0 < c && (e = l[--c], rh.applyToEditor(u, e, !0), d(!0), u.fire("undo", {level: e})), e
            }, redo: function () {
                var e;
                return c < l.length - 1 && (e = l[++c], rh.applyToEditor(u, e, !1), d(!0), u.fire("redo", {level: e})), e
            }, clear: function () {
    ...
    var ih, ah, uh = function (e) {
        ...
        isInlineBlock: uh, moveStart: function (e, t, n) {
            var r, o, i, a = n.startOffset, u = n.startContainer;
            if ((n.startContainer !== n.endContainer || !uh(n.startContainer.childNodes[n.startOffset])) && 1 === u.nodeType) for (a < (i = u.childNodes).length ? r = new no(u = i[a], e.getParent(u, e.isBlock)) : (r = new no(u = i[i.length - 1], e.getParent(u, e.isBlock))).next(!0), o = r.current(); o; o = r.next()) if (3 === o.nodeType && !sh(o)) return n.setStart(o, 0), void t.setRng(n)
        }, getNonWhiteSpaceSibling: function (e, t, n) {
            if (e) for (t = t ? "nextSibling" : "previousSibling", e = n ? e : e[t]; e; e = e[t]) if (1 === e.nodeType || !sh(e)) return e
        ...
        }, isWhiteSpaceNode: sh, replaceVars: function (e, n) {
        ...
        }, normalizeStyleValue: ch, getStyle: function (e, t, n) {
    ...
    }, fh = Bc.isBookmarkNode, dh = lh.getParents, mh = lh.isWhiteSpaceNode, ph = lh.isTextBlock, gh = function (e, t) {
        ...
        var a, u, s, c;
        if (3 === n.nodeType) {
            if (-1 !== (s = vh(o, i, n, r))) return {container: n, offset: s};
            c = n
        }
        for (a = new no(n, e.getParent(n, e.isBlock) || t); u = a[o ? "prev" : "next"]();) if (3 === u.nodeType) {
            if (-1 !== (s = vh(o, i, c = u))) return {container: u, offset: s}
        } else if (e.isBlock(u)) break;
        if (c) return {container: c, offset: r = o ? 0 : c.length}
    }, bh = function (e, t, n, r, o) {
        var i, a, u, s;
        for (3 === r.nodeType && 0 === r.nodeValue.length && r[o] && (r = r[o]), i = dh(e, r), a = 0; a < i.length; a++) for (u = 0; u < t.length; u++) if (!("collapsed" in (s = t[u]) && s.collapsed !== n.collapsed) && e.is(i[a], s.selector)) return i[a];
        return r
    }, Ch = function (t, e, n, r) {
        ...
        if (o && e[0].wrapper && (o = dh(i, o, "ul,ol").reverse()[0] || o), !o) for (o = n; o[r] && !i.isBlock(o[r]) && (o = o[r], !lh.isEq(o, "br"));) ;
        return o || n
        ...
        for (; ;) {
            ...
            for (c = s[l]; c; c = c[l]) if (!fh(c) && !mh(c) && ("BR" !== (d = c).nodeName || !d.getAttribute("data-mce-bogus") || d.nextSibling)) return s;
        ...
        } else for (s = 0; s < c.length; s++) if ("attributes" === r ? e.getAttrib(t, c[s]) : lh.getStyle(e, t, c[s])) return n;
        return n
    }, Ah = function (e, t, n, r, o) {
        var i, a, u, s, c = e.formatter.get(n), l = e.dom;
        if (c && t) for (a = 0; a < c.length; a++) if (i = c[a], kh(e.dom, t, i) && Th(l, t, i, "attributes", o, r) && Th(l, t, i, "styles", o, r)) {
            if (s = i.classes) for (u = 0; u < s.length; u++) if (!e.dom.hasClass(t, s[u])) return;
            return i
        }
    }, Rh = {
        matchNode: Ah, matchName: kh, match: function (e, t, n, r) {
            var o;
            ...
            if (u) for (n = e.selection.getStart(), r = lh.getParents(s, n), i = u.length - 1; 0 <= i; i--) {
    ...
    }, Dh = Ei, Oh = "_mce_caret", Ph = function (e) {
        return 0 < function (e) {
            for (var t = []; e;) {
        ...
        var t;
        if (e) for (e = (t = new no(e, e)).current(); e; e = t.next()) if (3 === e.nodeType) return e;
        return null
    }, Ih = function (e) {
        ...
        if (r) Mh(t, n, r, o); else if (!(r = wc(e, n.getStart()))) for (; r = t.get(Oh);) Mh(t, n, r, !1)
    }, zh = function (e, t, n) {
        var r = e.dom, o = r.getParent(n, ua.curry(lh.isTextBlock, e));
        ...
        var i = e.dom, a = e.selection, u = e.getBody();
    ...
    var Kh = function (e, t) {
    ...
    }, Gh = /^(src|href|style)$/, Jh = Lt.each, Qh = lh.isEq, Zh = function (e) {
        ...
        if ("all" !== n.remove) for (Jh(n.styles, function (e, t) {
        ...
        removeFormat: rv, remove: function (s, c, l, e, f) {
            var t, n, d = s.formatter.get(c), m = d[0], a = !0, u = s.dom, r = s.selection, o = function (e) {
                var n, t, r, o, i, a,
                    u = (n = s, t = e, r = c, o = l, i = f, Jh(lh.getParents(n.dom, t.parentNode).reverse(), function (e) {
                        var t;
                ...
                return function (e, t, n, r, o, i, a, u) {
                    ...
                    if (n) {
                        for (m = n.parentNode, s = r.parentNode; s && s !== m; s = s.parentNode) {
                            for (c = p.clone(s, !1), d = 0; d < t.length; d++) if (rv(e, t[d], u, c, c)) {
                                c = 0;
                                break
                            }
                ...
                var t, n, r, o, i;
                if (Ao.isElement(e) && u.getContentEditable(e) && (o = a, a = "true" === u.getContentEditable(e), i = !0), t = Lt.grep(e.childNodes), a && !i) for (n = 0, r = d.length; n < r && !rv(s, d[n], l, e, e); n++) ;
                if (m.deep && t.length) {
                    for (n = 0, r = t.length; n < r; n++) p(t[n]);
                    i && (a = o)
                }
            }, i = function (e) {
                var t = u.get(e ? "_start" : "_end"), n = t[e ? "firstChild" : "lastChild"];
            ...
            if (e) e.nodeType ? ((n = u.createRng()).setStartBefore(e), n.setEndAfter(e), g(n)) : g(e); else if ("false" !== u.getContentEditable(r.getNode())) r.isCollapsed() && m.inline && !u.select("td[data-mce-selected],th[data-mce-selected]").length ? function (e, t, n, r) {
                var o, i, a, u, s, c, l, f = e.dom, d = e.selection, m = [], p = d.getRng();
                ...
                if (c) if (u) {
                    ...
                    l = wc(e.getBody(), c);
                    var h = Ih(!1).dom(), v = qh(m, h);
                    zh(e, h, l || c), Mh(f, d, l, !1), d.setCursorLocation(v, 1), f.isEmpty(c) && f.remove(c)
                }
            }(s, c, l, f) : (t = bc.getPersistentBookmark(s.selection, !0), g(r.getRng()), r.moveToBookmark(t), m.inline && Rh.match(s, c, l, r.getStart()) && lh.moveStart(u, r, r.getRng()), s.nodeChanged()); else {
                e = r.getNode();
                for (var h = 0, v = d.length; h < v && (!d[h].ceFalseOverride || !rv(s, d[h], l, e, e)); h++) ;
            }
        }
    }, iv = Lt.each, av = function (e) {
    ...
    }, Cv = Lt.each, xv = function (p, g, h, r) {
        var e, t, v = p.formatter.get(g), y = v[0], o = !r && p.selection.isCollapsed(), i = p.dom, n = p.selection,
            b = function (n, e) {
                if (e = e || y, n) {
                ...
                l = y.inline || y.block, f = s.create(l), b(f), Yh.walk(s, e, function (e) {
                    var a, u = function (e) {
                        ...
                        if (y.wrapper && Rh.matchNode(p, e, g, h)) a = 0; else {
        ...
        if ("false" !== i.getContentEditable(n.getNode())) {
            if (y) {
                if (r) r.nodeType ? C(v, r) || ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, wh(p, t, v), 0, !0)) : a(i, r, 0, !0); else if (o && y.inline && !i.select("td[data-mce-selected],th[data-mce-selected]").length) !function (e, t, n) {
    ...
    }, kv = Lt.each, Tv = di.DOM, Av = function (e, t) {
        var n, o, r, m = t && t.schema || Zo({}), p = function (e) {
            var t, n, r;
            ...
            if (u = d, s = "string" != typeof (a = n) ? a.nodeName.toLowerCase() : a, c = m.getElementRule(s), i = !(!(l = c && c.parentsRequired) || !l.length) && (u && -1 !== Lt.inArray(l, u) ? u : l[0])) d === i ? (o = e[0], e = e.slice(1)) : o = i; else if (f) o = e[0], e = e.slice(1); else if (!t) return n;
        ...
        return e && "string" == typeof e ? (e = (e = e.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), Lt.map(e.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
            var t = Lt.map(e.split(/(?:~\+|~|\+)/), Rv), n = t.pop();
        ...
        }, parseSelector: Bv, selectorToHtml: function (e, t) {
            return Av(Bv(e), t)
        }
    }, Dv = {
    ...
    var Lv = function (a) {
            ...
            return t
        }), Fv = {deepMerge: Iv, merge: Mv}, zv = function (e, t) {
            ...
            process: function (e, t, n) {
                ...
                }), o = "BODY" !== o.nodeName ? u.body.firstChild : u.body, s = c.doc, c.doc = u), zv(r, Fv.merge(i, {node: o})), s && (c.doc = s), o) : t;
                var r, o, i, a, u, s, c, l, f
            }
        }, jv = function (e, u, s) {
            e.addNodeFilter("font", function (e) {
                H.each(e, function (e) {
                    var t, n, r = u.parse(e.attr("style")), o = e.attr("color"), i = e.attr("face"), a = e.attr("size");
        ...
        Xv = {"#text": 3, "#comment": 8, "#cdata": 4, "#pi": 7, "#doctype": 10, "#document-fragment": 11},
        Yv = function (e, t, n) {
            ...
            return a.create = function (e, t) {
                var n, r;
                if (n = new a(e, Xv[e] || 1), t) for (r in t) n.attr(r, t[r]);
                return n
            ...
            g.remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
                var r, o, i, a, u, s, c, l, f = e.length, d = Lt.extend({}, h.getBlockElements()),
                    m = h.getNonEmptyElements(), p = h.getNonEmptyElements();
                ...
                if (!g.allow_unsafe_link_target) for (; o--;) "a" === (t = e[o]).name && "_blank" === t.attr("target") && t.attr("rel", (n = t.attr("rel"), r = n ? Lt.trim(n) : "", /\b(noopener)\b/g.test(r) ? r : r.split(" ").filter(function (e) {
                    return 0 < e.length
        ...
        }, ry = Lt.makeMap, oy = Lt.each, iy = Lt.explode, ay = Lt.extend;
        ...
        var D = function (e) {
            ...
            schema: T, addAttributeFilter: function (e, n) {
                ...
                if (t.parse(e), h && m.length && (a.context ? a.invalid = !0 : function (e) {
                    ...
                    for (d = ry("tr,td,th,tbody,thead,tfoot,table"), l = T.getNonEmptyElements(), f = T.getWhiteSpaceElements(), m = T.getTextBlockElements(), p = T.getSpecialElements(), t = 0; t < e.length; t++) if ((n = e[t]).parent && !n.fixed) if (m[n.name] && "li" === n.parent.name) {
                    ...
                    for (r = 0, o = R.length; r < o; r++) if ((s = R[r]).name in _) {
    ...
    var sy = function (e, t, n) {
        ...
        var o = r.selection ? Fv.merge({forced_root_block: !1}, r) : r, i = e.parse(n, o);
        return Vv.trimTrailingBr(i), i
    }, fy = function (e, t, n, r, o) {
        var i, a, u, s, c = (i = r, jc(t, n).serialize(i));
        return a = e, s = c, !(u = o).no_events && a ? Uv(a, Fv.merge(u, {content: s})).content : s
    };

    function dy(e, t) {
        var a, u, s, c, l, n,
            r = (a = e, n = ["data-mce-selected"], s = (u = t) && u.dom ? u.dom : di.DOM, c = u && u.schema ? u.schema : Zo(a), a.entity_encoding = a.entity_encoding || "named", a.remove_trailing_brs = !("remove_trailing_brs" in a) || a.remove_trailing_brs, l = uy(a, c), Vv.register(l, a, s), {
                schema: c,
                addNodeFilter: l.addNodeFilter,
                addAttributeFilter: l.addAttributeFilter,
                serialize: function (e, t) {
                    var n = Fv.merge({format: "html"}, t || {}), r = Hv.process(u, e, n), o = cy(s, r, n),
                        i = ly(l, s, o, n);
    ...
    function my(e) {
        return {getBookmark: V.curry(Bc.getBookmark, e), moveToBookmark: V.curry(Bc.moveToBookmark, e)}
    }

    (my || (my = {})).isBookmarkNode = Bc.isBookmarkNode;
    var py = my, gy = Ao.isContentEditableFalse, hy = Ao.isContentEditableTrue, vy = function (r, a) {
            var u, s, c, l, f, d, m, p, g, h, v, y, i, b, C, x, w, N = a.dom, E = Lt.each, S = a.getDoc(), k = document,
                T = Math.abs, A = Math.round, R = a.getBody();
            ...
            var B = function (e) {
                ...
                t = e.screenX - d, n = e.screenY - m, b = t * f[2] + h, C = n * f[3] + v, b = b < 5 ? 5 : b, C = C < 5 ? 5 : C, (B(u) && !1 !== a.settings.resize_img_proportional ? !kg.modifierPressed(e) : kg.modifierPressed(e) || B(u) && f[2] * f[3] != 0) && (T(t) > T(n) ? (C = A(b * y), b = A(C / y)) : (b = A(C / y), C = A(b * y))), N.setStyles(_(s), {
                    ...
                    left: r - t,
                    top: o - n
                }), i || (a.fire("ObjectResizeStart", {target: u, width: h, height: v}), i = !0)
            }, P = function () {
                i = !1;
                var e = function (e, t) {
                ...
                var t, r, o, n, i;
                L(), F(), t = N.getPos(e, R), p = t.x, g = t.y, i = e.getBoundingClientRect(), r = i.width || i.right - i.left, o = i.height || i.bottom - i.top, u !== e && (u = e, b = C = 0), n = a.fire("ObjectSelected", {target: e}), D(e) && !n.isDefaultPrevented() ? E(l, function (n, e) {
                    var t;
            ...
            return sa([(i = e, a = i.startContainer, u = i.startOffset, Ao.isText(a) ? 0 === u ? A.some(qn.fromDom(a)) : A.none() : A.from(a.childNodes[u]).map(qn.fromDom)), (t = e, n = t.endContainer, r = t.endOffset, Ao.isText(n) ? r === n.data.length ? A.some(qn.fromDom(n)) : A.none() : A.from(n.childNodes[r - 1]).map(qn.fromDom))], function (e, t) {
                var n = H.find(ky(o), V.curry(Or.eq, e)), r = H.find(Ty(o), V.curry(Or.eq, t));
                return n.isSome() && r.isSome()
            }).getOr(!1);
            var t, n, r, i, a, u
        }, Ry = function (e, t, n, r) {
            var o = n, i = new no(n, o), a = e.schema.getNonEmptyElements();
            do {
        ...
        }, By = wr.immutable("element", "width", "rows"), _y = wr.immutable("element", "cells"),
        Dy = wr.immutable("x", "y"), Oy = function (e, t) {
            ...
            for (var n = e.rows(), r = 0; r < n.length; r++) for (var o = n[r].cells(), i = 0; i < o.length; i++) if (Or.eq(o[i], t)) return A.some(Dy(i, r));
            return A.none()
            ...
            var n, r = qn.fromDom(t.commonAncestorContainer), o = Ml(r, e), i = H.filter(o, function (e) {
                    return co(e) || uo(e)
                }), a = Uy(o, t),
            ...
            return (t = e, n = o[0], bl(n, "table", V.curry(Or.eq, t))).bind(function (e) {
                var t = o[0], n = o[o.length - 1], r = My(e);
            ...
            var n, r = e.selection.getRng(), o = e.dom.create("body"), i = e.selection.getSel(), a = Cy(e, xd(i));
            ...
            var n, t, l, f, a, r = function (e, t) {
                ...
                getSelectedBlocks: function (e, t) {
                    return function (e, t, n, r) {
                        var o, i, a = [];
                        if (i = e.getRoot(), n = e.getParent(n || Yy(i, t, !1), e.isBlock), r = e.getParent(r || Gy(i, t, !1), e.isBlock), n && n !== i && a.push(n), n && r && n !== r) for (var u = new no(o = n, i); (o = u.next()) && o !== r;) e.isBlock(o) && a.push(o);
        ...
        }, nb = Ao.isContentEditableFalse, rb = ta, ob = ks, ib = Ss, ab = function (e, t) {
            for (; t = e(t);) if (t.isVisible()) return t;
            return t
        }, ub = function (e, t, n, r) {
            var o, i, a, u, s, c, l = e === eu.Forwards, f = l ? ib : ob;
            ...
            if (d) {
                var m = function (e, t, n, r) {
                    var o, i, a, u, s, c, l = js(t), f = [], d = 0, m = function (e) {
            ...
            var r, o, i, a, u = js(e.getBody()), s = ua.curry(ab, u.next), c = ua.curry(ab, u.prev);
            ...
            return function () {
                var e, t, n, r, o, i, a, u, s,
                    c = (t = f, r = js((e = l).getBody()), o = ua.curry(ab, r.next), i = ua.curry(ab, r.prev), a = t ? eu.Forwards : eu.Backwards, u = t ? o : i, s = e.selection.getRng(), (n = ub(a, e, u, s)) ? n : (n = cb(e, a, s)) || null);
                return !!c && (l.selection.setRng(c), !0)
            }
        }, fb = function (u, s) {
            return function () {
                var e, t, n, r, o, i,
                    a = (r = (t = s) ? 1 : -1, o = t ? dg : fg, i = (e = u).selection.getRng(), (n = sb(r, e, o, i)) ? n : (n = cb(e, r, i)) || null);
                return !!a && (u.selection.setRng(a), !0)
            }
        }, db = function (e, r) {
            return H.bind((t = e, H.map(t, function (e) {
                return Fv.merge({shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0, action: V.noop}, e)
            })), function (e) {
            ...
            i.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() && (t = i, n = a, r = e, o = zn.detect().os, pb([{
                    keyCode: kg.RIGHT,
                    action: lb(t, !0)
                }, {keyCode: kg.LEFT, action: lb(t, !1)}, {keyCode: kg.UP, action: fb(t, !1)}, {
                    keyCode: kg.DOWN,
                    action: fb(t, !0)
                }, {keyCode: kg.RIGHT, action: Yu(t, !0)}, {keyCode: kg.LEFT, action: Yu(t, !1)}, {
                    keyCode: kg.UP,
                    action: Gu(t, !1)
                }, {keyCode: kg.DOWN, action: Gu(t, !0)}, {keyCode: kg.RIGHT, action: td.move(t, n, !0)}, {
                    keyCode: kg.LEFT,
            ...
            var o, i, a, u, s = V.curry(Hh, t), c = H.map(H.filter(r, s), function (e) {
                return e.dom()
            });
            if (0 === c.length) lf(t, e, n); else {
                var l = (o = n.dom(), i = c, a = Ih(!1), u = qh(i, a.dom()), Fu.before(qn.fromDom(o), a), Ic.remove(qn.fromDom(o)), Ba(u, 0));
                t.selection.setRng(l.toRange())
            }
        }, yb = function (n, r) {
            var t, e = qn.fromDom(n.getBody()), o = qn.fromDom(n.selection.getStart()),
            ...
            o.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() && (t = o, n = i, r = e, pb([{
                    ...
                    action: mb(mf, t, !1)
                }, {keyCode: kg.DELETE, action: mb(mf, t, !0)}, {
                    keyCode: kg.BACKSPACE,
                    action: mb(id, t, n, !1)
                }, {keyCode: kg.DELETE, action: mb(id, t, n, !0)}, {
                    keyCode: kg.BACKSPACE,
                    action: mb(Xl, t, !1)
                }, {keyCode: kg.DELETE, action: mb(Xl, t, !0)}, {
                    keyCode: kg.BACKSPACE,
                    action: mb(jl, t, !1)
                }, {keyCode: kg.DELETE, action: mb(jl, t, !0)}, {
                    keyCode: kg.BACKSPACE,
                    action: mb(Fd, t, !1)
                }, {keyCode: kg.DELETE, action: mb(Fd, t, !0)}, {
                    keyCode: kg.BACKSPACE,
                    action: mb(bb, t, !1)
                }, {keyCode: kg.DELETE, action: mb(bb, t, !0)}], r).each(function (e) {
                    r.preventDefault()
                }))
                ...
                !1 === e.isDefaultPrevented() && (t = o, n = e, pb([{
                    keyCode: kg.BACKSPACE,
                    action: mb(pf, t)
                }, {keyCode: kg.DELETE, action: mb(pf, t)}], n))
            })
        }, xb = function (e) {
            ...
            if (n !== e.getBody()) {
                ...
                if (Bb(n, r, !0) && Bb(n, r, !1)) Tb(n, "LI") ? i.insertAfter(l, Rb(n)) : i.replace(l, n); else if (Bb(n, r, !0)) Tb(n, "LI") ? (i.insertAfter(l, Rb(n)), l.appendChild(i.doc.createTextNode(" ")), l.appendChild(n)) : n.parentNode.insertBefore(l, n); else if (Bb(n, r, !1)) i.insertAfter(l, Rb(n)); else {
                    n = Rb(n);
                    var f = a.cloneRange();
            ...
            var t, u, s, i, c, n, r, o, l, f, d, m, p, g, h, v, y, b, C = a.dom, x = a.schema, w = x.getNonEmptyElements(),
                N = a.selection.getRng(), E = function (e) {
                    var t, n, r, o = s, i = x.getTextInlineElements();
                    if (e || "TABLE" === f || "HR" === f ? (t = C.create(e || m), Mb(a, t)) : t = c.cloneNode(!1), r = t, !1 === Du(a)) C.setAttrib(t, "style", null), C.setAttrib(t, "class", null); else do {
                        if (i[o.nodeName]) {
                            if (xc(o)) continue;
            ...
            rm.normalize(C, N).each(function (e) {
                ...
                var i, a, u, s, c, l, f, d = t || "P", m = e.dom, p = Ib(m, r);
            ...
            }(C, w, r), g = C, (h = c).normalize(), (v = h.lastChild) && !/^(left|right)$/gi.test(g.getStyle(v, "float", !0)) || g.add(h, "br"), C.isEmpty(c) && Db(c), r.normalize(), C.isEmpty(r) ? (C.remove(r), k()) : wb(a, r)), C.setAttrib(r, "id", ""), a.fire("NewBlock", {newBlock: r})))
        }, zb = function (e, t) {
            ...
            return zb(e, _u(e))
        }, Vb = Yl([{br: []}, {block: []}, {none: []}]), Hb = function (e, t) {
            return qb(e)
        }, jb = function (n) {
            return function (e, t) {
                return "" === Au(e) === n
            ...
            var t = Au(e), n = Nb(e.dom, e.selection.getStart());
    ...
    function cC(u) {
        var s, n, r, o = Lt.each, c = kg.BACKSPACE, l = kg.DELETE, f = u.dom, d = u.selection, e = u.settings,
            t = u.parser, i = ge.gecko, a = ge.ie, m = ge.webkit, p = "data:text/mce-internal,", g = a ? "Text" : "URL",
            h = function (e, t) {
                try {
    ...
    var lC = function (e) {
            ...
            t.on("click", function (e) {
                3 === e.detail && function (e) {
                    var t = e.selection.getRng(), n = Ta.fromRangeStart(t), r = Ta.fromRangeEnd(t);
        ...
        }, dC = di.DOM, mC = function (e) {
            var t;
            e.bindPendingEventDelegates(), e.initialized = !0, e.fire("init"), e.focus(!0), e.nodeChanged({initial: !0}), e.execCallback("init_instance_callback", e), (t = e).settings.auto_focus && Ce.setEditorTimeout(t, function () {
                var e;
            ...
            return e.contentAreaContainer = t.iframeContainer, e.iframeElement = l, e.iframeHTML = (p = wu(f = e) + "<html><head>", Nu(f) !== f.documentBaseUrl && (p += '<base href="' + f.documentBaseURI.getURI() + '" />'), p += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />', d = Eu(f), m = Su(f), ku(f) && (p += '<meta http-equiv="Content-Security-Policy" content="' + ku(f) + '" />'), p += '</head><body id="' + d + '" class="mce- ' + m + '" data-id="' + f.id + '"><br></body></html>'), gC.add(t.iframeContainer, l), g
        }, vC = function (e, t) {
            var n = hC(e, t);
            ...
            !function (e, t, n, r) {
                ...
                e = u, (n = (t = i).settings).language && "en" !== n.language && !n.language_url && (n.language_url = t.editorManager.baseURL + "/langs/" + n.language + ".js"), n.language_url && !t.editorManager.i18n.data[n.language] && e.add(n.language_url), r = i.settings, o = a, Lt.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), Lt.each(r.external_plugins, function (e, t) {
                    ...
                    if ((e = Lt.trim(e)) && !Tp.urls[e]) if (kC(e)) {
                    ...
                    } else Tp.load(e, {prefix: "plugins/", resource: e, suffix: "/plugin" + o + ".js"})
        ...
        }, BC = Lt.each, _C = Lt.trim,
        DC = "source protocol authority userInfo user password host port relative path directory file query anchor".split(" "),
        OC = {ftp: 21, http: 80, https: 443, mailto: 25}, PC = function (r, e) {
            var t, n, o = this;
            if (r = _C(r), t = (e = o.settings = e || {}).base_uri, /^([\w\-]+):([^\/]{2})/i.test(r) || /^\s*#/.test(r)) o.source = r; else {
                var i = 0 === r.indexOf("//");
    ...
    PC.prototype = {
        setPath: function (e) {
            ...
            var t;
            if ("./" === e) return e;
            if ("mce_host" !== (e = new PC(e, {base_uri: this})).host && this.host !== e.host && e.host || this.port !== e.port || this.protocol !== e.protocol && "" !== e.protocol) return e.getURI();
            ...
            return (e = new PC(e, {base_uri: this})).getURI(t && this.isSameOrigin(e))
    ...
    var LC = function (e, t) {
        ...
        var r, o, i, a, u;
        if (t.format = t.format ? t.format : "html", t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) r = Lt.trim(Ug.trimExternal(e.serializer, n.innerHTML)); else if ("text" === t.format) r = Si(n.innerText || n.textContent); else {
        ...
        return void 0 === c && (c = {}), c.format = c.format ? c.format : "html", c.set = !0, c.content = MC(s) ? "" : s, MC(s) || c.no_events || (u.fire("BeforeSetContent", c), s = c.content), A.from(u.getBody()).fold(V.constant(s), function (e) {
            return MC(s) ? function (e, t, n, r) {
                ...
                var o = jc({validate: e.validate}, e.schema).serialize(n);
    ...
    }, jC = di.DOM, $C = Lt.extend, WC = Lt.each, KC = Lt.resolve, XC = ge.ie, YC = function (e, t, n) {
    ...
    $C(YC.prototype = {
        render: function () {
            ...
            r.contextToolbars = r.contextToolbars || [], "string" == typeof e && (n = e, e = function (e) {
                return r.dom.is(e, n)
            }), r.contextToolbars.push({id: jp.uuid("mcet"), predicate: e, items: t})
            ...
            t && (e = $C({content: e}, t)), this.execCommand("mceInsertContent", !1, e)
        }, isDirty: function () {
    ...
    var GC, JC, QC, ZC = {
            ...
            tx(t), t.on("focusin", function () {
                ...
                t = e.target, n && t.ownerDocument === document && (t === document.body || ox(n, t) || r.focusedEditor !== n || (n.fire("blur", {focusedEditor: null}), r.focusedEditor = null))
        ...
        }, fx = di.DOM, dx = Lt.explode, mx = Lt.each, px = Lt.extend, gx = 0, hx = !1, vx = [], yx = [],
        bx = function (t) {
    ...
    px(QC = {
        ...
        setup: function () {
            var e, t, n, r, o = "";
            if (t = PC.getDocumentBaseUrl(document.location), /^[^:]+:\/\/\/?[^\/]+\//.test(t) && (t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(t) || (t += "/")), n = window.tinymce || window.tinyMCEPreInit) e = n.base || n.baseURL, o = n.suffix; else {
        ...
        init: function (r) {
            ...
            var c = function (e) {
                ...
                fx.unbind(window, "ready", e), function (e) {
                    var t = r[e];
        ...
        add: function (e) {
            var t = this;
            return vx[e.id] === e || (null === t.get(e.id) && ("length" !== e.id && (vx[e.id] = e), vx.push(e), yx.push(e)), Cx(!0), t.activeEditor = e, t.fire("AddEditor", {editor: e}), JC || (JC = function () {
                t.fire("BeforeUnload")
        ...
        remove: function (e) {
            ...
            })) : (n = e, E.isNull(r.get(n.id)) ? null : (xx(n) && r.fire("RemoveEditor", {editor: n}), 0 === yx.length && fx.unbind(window, "beforeunload", JC), n.remove(), Cx(0 < yx.length), n));
    ...
    function Ex(n) {
        return {
            ...
            }, split: _h.split, normalize: function (t) {
    ...
    var Sx, kx, Tx = Ex, Ax = Math.min, Rx = Math.max, Bx = Math.round, _x = function (e, t, n) {
        var r, o, i, a, u, s;
        ...
        }, relativePosition: _x, findBestRelativePosition: function (e, t, n, r) {
            var o, i;
            for (i = 0; i < r.length; i++) if ((o = _x(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
            return null
        ...
        }, create: Dx, fromClientRect: function (e) {
        ...
        add: function (e, t) {
            ...
            var t = e.toLowerCase(), n = Px.hasOwnProperty(t) ? Px[t] : null;
    ...
    }, Ix = Lt.each, Mx = Lt.extend, Fx = function () {
    };
    Fx.extend = Sx = function (n) {
        var e, t, r, o = this.prototype, i = function () {
            var e, t, n;
            if (!kx && (this.init && this.init.apply(this, arguments), t = this.Mixins)) for (e = t.length; e--;) (n = t[e]).init && n.init.apply(this, arguments)
        }, a = function () {
            return this
        }, u = function (n, r) {
            return function () {
    ...
    var zx = Math.min, Ux = Math.max, qx = Math.round, Vx = function (e, n) {
        var r, o, t, i;
        ...
        send: function (e) {
            ...
            if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", $x.fire("beforeInitialize", {settings: e}), t = new Rp) {
    ...
    Lt.extend($x, Vm);
    var Wx = Lt.extend, Kx = function (e) {
    ...
    Kx.sendRPC = function (e) {
        ...
        send: function (n) {
            ...
            (n = Wx(this.settings, n)).success = function (e, t) {
                void 0 === (e = Hx.parse(e)) && (e = {error: "JSON Parse error."}), e.error ? r.call(n.error_scope || n.scope, e.error, t) : o.call(n.success_scope || n.scope, e.result)
    ...
    var Xx, Yx = window.localStorage, Gx = Nx, Jx = {
        geom: {Rect: Ox},
        util: {
            Promise: he,
            Delay: Ce,
    ...
    Xx = Qx, window.tinymce = Xx, window.tinyMCE = Xx, function (e) {
