...
namespace App\Http\Controllers\Api\Admin\Settings\Users;
...
class UsersController extends Controller
{
    ...
    public function storeUser()
    {
        ...
        $user = ShRepository::autoSaveModel($this->api_model, $data);
    ...
    public function listAdminUsers()
    {
        ...
        $table = 'users';
        $search_keys = array_keys($this->getValidationRules());
        return [
            'status' => 'success',
    ...
    {
        $users = User::where('role', Str::singular($role));
        $search_keys = array_keys(['name', 'email', 'phone']);
        //            $search_keys[] = 'users.name';
        return [
            'status' => 'success',
            'data' => SearchRepo::of($users, null, $search_keys)
                ->make(true)
        ];
    }
