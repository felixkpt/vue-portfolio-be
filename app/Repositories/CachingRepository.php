...
class CachingRepository
{
    ...
    public function getCachePeriods(){
        $periods = [
            ...
            'last_30_days'=>[now()->subMonth()->startOfMonth(),now()->endOfDay()],
            'last_60_days'=>[now()->subMonths(2)->startOfMonth(),now()->endOfDay()],
            'last_90_days'=>[now()->subMonths(3)->startOfMonth(),now()->endOfDay()],
